    ...
    const fetchPost = async () => {
      try {
        ...
        reset({
          ...
          minBudget: data.budgetRange.min,
          maxBudget: data.budgetRange.max,
    ...
    <div className="min-h-screen bg-[#f3f4f6] py-12 px-4 font-sans">
      ...
      >
        <div className="bg-[#0b2b56] p-6 text-white">
          <h1 className="text-2xl font-bold">Edit Roommate Profile</h1>
          <p className="text-white/80 text-sm mt-1">Update your roommate preferences.</p>
        </div>
...
export default EditRoommatePost;
